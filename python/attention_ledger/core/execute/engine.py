...
class ExecutionEngine:
    ...
    async def run_task(
        ...
        if simulator:
            ...
            # Fallback for tasks without HTML
        ...
        for step in range(1, max_steps + 1):
            ...
            # 2. Execute Action
            log_msg = f"Action: {action.action} | Target: {action.target} | Note: {action.note}"
            print(log_msg)
            ...
            if step_callback:
                await step_callback({
                    ...
                    "simulated": simulator is not None
                })
            ...
            if action.action == "done":
                ...
                # Mock state transition if no simulator
