...
| 製品 | 位置づけ | 参考価格 |
| --- | --- | --- |
| Jabra Speak2 55 MS | 標準候補 | ￥18,293 |
| Anker PowerConf S3 | 安価な標準候補 | ￥9,990 |
| Anker PowerConf S500 | 上位候補 | ￥26,700 |
| Audio-Technica ATR4697-USB | 卓上マイク候補 | ￥10,384 |
| PR-SK95CK USB-C スピーカーフォン | 廉価検証用 | ￥3,680 |
| SHURE MV88+ | 高音質検証用 | ￥26,480 |
| RØDE VideoMic Me-C+ | スマホ直結検証 | ￥14,800 |
| RØDE Wireless Micro | 個別収音向け | ￥18,000 |
| SENNHEISER XS LAV USB-C | 個人装着向け | ￥17,955 |
...
マイクは、まず **Anker PowerConf S3** か **Jabra Speak2 55** で検証するのがよい。
