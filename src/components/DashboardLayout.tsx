...
import { LayoutDashboard, Play, History, Settings, Zap, ListChecks, FlaskConical, Wine, ShieldCheck } from 'lucide-react';
    ...
    <div className="flex h-screen bg-background text-white overflow-hidden font-sans">
      ...
      <aside className="w-64 bg-surface border-r border-border flex flex-col p-5">
        ...
        <nav className="space-y-1 flex-1">
          ...
          <NavItem href="/hermes" icon={<ShieldCheck size={20} />} label="Hermes" />
